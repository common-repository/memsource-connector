...
class LogUtils
{
    ...
    const ERROR_LOG_PATH_NOT_WRITABLE = 'LOG_PATH_NOT_WRITABLE';
    const ERROR_LOG_PATH_NOT_DIRECTORY = 'LOG_PATH_NOT_DIRECTORY';
    const ERROR_RELATIVE_PATH_NOT_ALLOWED = 'RELATIVE_PATH_NOT_ALLOWED';

    public static function getLogFilePath(): string
    {
        return self::getLogFileFolder() . self::LOG_FILE_NAME;
    }

    public static function getZipFilePath(): string
    {
        return self::getLogFileFolder() . self::ZIP_FILE_NAME;
    }

    private static function getLogFileFolder()
    {
        $optionsService = new OptionsService();
        $path = $optionsService->getLogFilePath();

        if (empty($path)) {
            $path = MEMSOURCE_PLUGIN_PATH;
        }
    ...
    public static function logSystemInfo()
    {
        ...
        $systemData = [
            ...
            'Installed shortcodes' => array_keys($shortcode_tags),  // phpcs:ignore
