...
class ShortcodePage extends AbstractPage
{
    ...
    public function renderPage()
    {
        ...
        <div class="memsource-admin-section-description"><?php _e('This page displays all shortcodes from which Phrase TMS can extract a text to translate.', 'memsource'); ?></div>
        <div class="memsource-space"></div>
