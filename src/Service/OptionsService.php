...
class OptionsService
{
    ...
    private $optionLogFilePath = 'memsource_log_file_path';
    ...
    public function initOptions(string $translationPlugin, bool $overwrite = false)
    {
        ...
        add_option($this->optionLogFilePath, null);
    ...
    {
        update_option($this->optionLogFilePath, $path);
    }

    public function getLogFilePath()
    {
        return get_option($this->optionLogFilePath);
    }
}
